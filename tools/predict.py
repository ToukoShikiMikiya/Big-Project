...
def parse_args():
    ...
    # Common params
    parser.add_argument("--config", help="The path of config file.", default='configs/unet/unet_cancer_256x256_40k.yml',
                        type=str)
    parser.add_argument(
        '--model_path',
    ...
    parser.add_argument(
        '--image_path',
        help='The image to predict, which can be a path of image, or a file list containing image paths, or a directory including images_original',
        type=str)
    parser.add_argument(
        '--save_dir',
    ...
    parser.add_argument(
        '--is_slide',
        help='Whether to predict images_original in sliding window method',
        action='store_true')
    parser.add_argument(
        '--crop_size',
        nargs=2,
    ...
    parser.add_argument(
        '--custom_color',
        nargs='+',
        help='Save images_original with a custom color map. Default: None, use paddleseg\'s default color map.',
        type=int)
...
def main(args):
    ...
    logger.info('The number of images_original: {}'.format(len(image_list)))
