...
"""
visualize the annotated images_original:
...
def parse_args():
    ...
    parser.add_argument(
        '--file_path',
        help='The file contains the path of origin and annotated images_original',
        type=str)
    parser.add_argument(
        '--pred_dir', help='the dir of predicted images_original', type=str)
    parser.add_argument(
        '--save_dir',
        help='The directory for saving the visualized images_original',
        type=str,
...
def get_images_path(file_path):
    """
    Get the path of origin images_original and annotated images_original.
    """
