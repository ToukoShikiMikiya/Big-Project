...
def parse_args():
    ...
    parser.add_argument(
        '--folder',
        help='the folder names of images_original and labels',
        type=str,
        nargs=2,
        default=['images_original', 'annotations'])
    parser.add_argument(
        '--second_folder',
    ...
    parser.add_argument(
        '--format',
        help='data format of images_original and labels, e.g. jpg or png.',
        type=str,
        nargs=2,
        default=['jpg', 'png'])
    parser.add_argument(
        '--postfix',
        help='postfix of images_original or labels',
        type=str,
        nargs=2,
        default=['', ''])
...
def generate_list(args):
    ...
    for dataset_split in args.second_folder:
        ...
        if not image_files:
            ...
            warnings.warn("No images_original in {} !!!".format(img_dir))
        ...
        if num_images != num_label and num_label > 0:
            raise Exception(
                "Number of images_original = {}    number of labels = {} \n"
                "Either number of images_original is equal to number of labels, "
