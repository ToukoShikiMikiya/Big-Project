...
def parse_args():
    ...
    parser.add_argument(
        'images_dir_name', help='the directory name of images_original', type=str)
    parser.add_argument(
    ...
    parser.add_argument(
        '--format',
        help='data format of images_original and labels, e.g. jpg, tif or png.',
        type=str,
        nargs=2,
        default=['jpg', 'png'])
    parser.add_argument(
...
def generate_list(args):
    ...
    if num_images != num_label:
        raise Exception(
            ...
            "The number of images_original is not equal to number of labels, "
